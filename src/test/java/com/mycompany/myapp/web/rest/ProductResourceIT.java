...
class ProductResourceIT {
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product().title(DEFAULT_TITLE).description(DEFAULT_DESCRIPTION).rating(DEFAULT_RATING).url(DEFAULT_URL);
        return product;
    }
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product().title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).rating(UPDATED_RATING).url(UPDATED_URL);
        return product;
    }
    ...
    void putExistingProduct() throws Exception {
        ...
        updatedProduct.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).rating(UPDATED_RATING).url(UPDATED_URL);
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.title(UPDATED_TITLE).rating(UPDATED_RATING).url(UPDATED_URL);
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).rating(UPDATED_RATING).url(UPDATED_URL);
